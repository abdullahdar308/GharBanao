...
return (
  <div className="flex max-w-[1920px] m-auto">
    ...
    <div>
      <div className="card w-full flex md:flex-row flex-col rounded-2xl pt-5 mt-24 md:mt-16 px-16 m-auto max-w-[1920px] relative fade-in transition duration-500 ease-in">
        <div className="px-12 sm:px-32 w-[80vw] md:w-1/2 h-[350px] md:h-[500px] flex justify-center items-center rounded-2xl bg-[#F4F8F7] overflow-hidden">
          <img
            className="max-h-full object-contain"
            src={product?.image}
            alt={product?.name || "Product"}
        ...
        <div className="py-8 pl-10 sm:pl-24 w-full md:w-1/2 mt-12">
          <h3 className="text-6xl font-semibold">{product?.name}</h3>
          <h4 className="mt-10 text-2xl font-semibold">
            Category: <span className="font-normal">{product?.category}</span>
          </h4>
