    ...
    <div className="homepage-container">
      <div className="homepage-content">
        <div className="main-sec">
          ...
          <div className="hero-sec pb-24 px-16 max-w-[1920px] m-auto">
            <div className="left-side">
              ...
              <div className="second-line">
                Experience the convenience of designing, budgeting, and shopping
                for your dream home with our all-in-one platform tailored to
                your needs.
              </div>
            ...
            <div className="right-side">
              <img className="herosec-img" src="/herosec-image.png" alt="" />
            </div>
          </div>
          <div className="px-32 mb-24 max-w-[1920px] m-auto">
            ...
            <div className="flex justify-between items-stretch">
              <div
                ...
                className="w-[30%] bg-[#EDF3F2] px-12 py-12 rounded-[30px] cursor-pointer hover:bg-[#2C3433] group transition-colors duration-300"
              >
                <div className="bg-white rounded-2xl p-5 inline-block transition-colors duration-300">
                  <img className="w-12" src={layoutIcon} alt="" />
                </div>
                <h2 className="text-3xl font-semibold mt-5 group-hover:text-white transition-colors duration-300">
                  House Layout Designing
                </h2>
                <p className="text-xl w-4/5 text-[#444] mt-6 group-hover:text-white transition-colors duration-300">
          ...
          <div className="px-32 mb-24 mt-12 max-w-[1920px] m-auto">
            <h1 className="text-center text-7xl font-semibold text-[#2c3433] mb-24 leading-[56px]">
              Frequently <br /> Asked Questions
            </h1>
            <div className="faq-accordion w-3/5 m-auto">
              {faqs.map((faq, index) => (
                <div
                  className={`faq-item ${
          ...
          <div className="px-44 mt-12 CTO-bg ">
            <div className="max-w-[1920px] m-auto">
              <div className="bg-[#468378] rounded-[36px] p-32">
                <h1 className="text-white text-center text-6xl font-semibold w-3/5 m-auto">
                  Step into the Driver's Seat of Your Dream Home Design Journey
                </h1>
                <h3 className="text-white text-center text-3xl m-auto mt-12">
                ...
                <div className="flex justify-center mt-16">
                  <button
                    onClick={handleLayoutCardClick}
                    className="bg-white text-2xl rounded-xl text-[#468378] font-medium px-8 py-4"
                  >
                    Design Now
                  </button>
                </div>
          ...
          <div className="px-44 bg-[#dae6e4] pt-32 ">
            <div className="max-w-[1920px] m-auto ">
              <div className="flex pb-16">
                <div className="w-[60%]">
                  <img className="logo w-[200px]" src="/logo.png" alt="" />
          ...
          <div className="bg-[#2C3433] flex justify-center py-5">
            <h3 className="text-white text-2xl flex">
              &copy; &nbsp;
              <img className="logo w-[100px]" src="/logo2.svg" alt="" />
              &nbsp; All Rights Reserved.
            </h3>
          </div>
        </div>
